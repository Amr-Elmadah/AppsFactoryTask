...
import com.tasks.appsfactorytask.data.remote.network.exception.NetworkException;
...
public class RxErrorHandlingCallAdapterFactory extends CallAdapter.Factory {
    ...
    private static class RxCallAdapterWrapper<R> implements CallAdapter<R, Object> {
        ...
        private AppsFactoryException asRetrofitException(final Throwable throwable) {
